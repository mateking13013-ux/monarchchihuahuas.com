...
export const puppies: Puppy[] = [
  {
    name: 'Bella', images: img('bella.jpg'), sex: 'Female', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Bruno', images: img('bruno.jpg'), sex: 'Male', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Chico', images: img('chico.jpg'), sex: 'Male', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Chiquita', images: img('chiquita.jpg'), sex: 'Female', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Daisy', images: img('daisy.jpg'), sex: 'Female', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Gizmo', images: img('gizmo.jpg'), sex: 'Male', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Lola', images: img('lola.jpg'), sex: 'Female', age: '8 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Luna', images: img('luna.jpg'), sex: 'Female', age: '8 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Nacho', images: img('nacho.jpg'), sex: 'Male', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Rosie', images: img('rosie.jpg'), sex: 'Female', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Taco', images: img('taco.jpg'), sex: 'Male', age: '10 weeks', status: 'Available', price: 750,
  ...
  {
    name: 'Tinkerbell', images: img('tinkerbell.jpg'), sex: 'Female', age: '8 weeks', status: 'Available', price: 750,
