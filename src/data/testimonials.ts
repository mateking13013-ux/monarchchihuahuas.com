...
export const testimonials: Testimonial[] = [
  {
    ...
    puppyName: 'Oliver',
    text: "Our boerboel pup, Oliver, is absolutely everything we hoped for and more. From the moment he stepped paw into our home he has been smart, friendly, and confident — he's already become the heart of our household. Throughout the entire adoption process the Elite BoerBoel team felt more like family than a breeder, walking us through every step with patience, honesty, and warmth. We always felt informed, never rushed, and the support didn't stop the day we drove home — they've stayed in touch ever since. We can't recommend Elite BoerBoel enough to any family looking for a healthy, well-loved boerboel pup."
  },
  {
    name: 'Michel',
    ...
    puppyName: 'Oliver',
    text: "My pup Oliver is smart, affectionate, and full of joyful energy — every single day he reminds me how lucky I am to have him in my life. The dedication and care that clearly went into raising him were obvious from our very first meeting; he came home confident, well-socialized, and already knowing the basics of crate and potty routines. The Elite BoerBoel family treated this like a partnership and not a transaction, and that has made all the difference. We absolutely could not have asked for a better-matched companion. Thank you for raising puppies the right way."
  },
  {
    name: 'Sophie & Tina',
    location: 'Denver, CO',
  ...
  },
  {
    ...
    puppyName: 'Rosie',
    text: "Rosie is, hands-down, the sweetest pup we could have ever asked for — cuddly, joyful, endlessly happy, and somehow she brings a smile to absolutely everyone she meets. From our very first inquiry to the day we brought her home, the Elite BoerBoel team went above and beyond, sending us photos, weight updates, and answering our many texts. We never once felt like just a customer. Thank you for helping us find our perfect match — we'll be lifelong fans of this little family-run program."
  },
  {
    name: 'Fany & Family',
  ...
  },
  {
    ...
    puppyName: 'Milo',
    text: "Milo has been such an incredible blessing to our family. He settled in almost immediately, loves playing endless games with our kids, and has already learned a handful of basic commands at his own pace. The professionalism and kindness we experienced throughout the entire process truly stood out — we felt informed, supported, and never pressured at any stage. The Elite BoerBoel team clearly treats every puppy like one of their own, and you can see that in every detail. Thank you for trusting us with our perfect boy."
  },
  {
    ...
    puppyName: 'Zoey',
    text: "Zoey has the most loving personality — she's playful and silly during the day, then turns into the world's most dedicated snuggler at night. The adoption process with Elite BoerBoel was smooth, transparent, and refreshingly honest from start to finish. We received clear updates, well-organized paperwork, and a starter kit that helped her transition easily into our home. We couldn't be happier with our experience and we recommend them to every boerboel-curious friend we have."
  },
  {
    name: 'Joseph Nu',
    location: 'Chicago, IL',
  ...
  },
  {
    ...
    puppyName: 'Maggie',
    text: "Maggie is the most wonderful pup we could have hoped for. She adjusted to our household within days, and her sweet, snuggly personality immediately won everyone over — including our cat, who tolerates her surprisingly well. We are deeply grateful for such an ethical, loving, and clearly conscientious breeder. Elite BoerBoel went above and beyond to make this experience smooth, informative, and even joyful. We are committed Elite BoerBoel families for life."
  },
  {
    name: 'Joseph Nu',
    location: 'Houston, TX',
    ...
    puppyName: 'Teddy',
    text: "Our boerboel, Teddy, is a wonderful bundle of love and energy who has completely changed the rhythm of our home for the better. The whole adoption process was easy and surprisingly enjoyable, and we genuinely appreciated the thoughtful updates we received along the way. You can absolutely tell these puppies are raised with kindness, structure, and a tremendous amount of hands-on attention from a real family. We've already recommended Elite BoerBoel to two other friends. Thank you for raising such a remarkable little guy."
  },
  {
    ...
    puppyName: 'CoCo',
    text: "CoCo has brought so much happiness, laughter, and warmth into our home in just a few short weeks. She's playful, deeply loving, and beautifully healthy — and her temperament is exactly what we were dreaming of. We could not have asked for a better experience from start to finish. The Elite BoerBoel team made every step feel personal, organized, and genuinely caring. The check-ins after pickup were a lovely surprise we didn't expect. Highly, highly recommended for any future boerboel family."
  },
  {
  ...
  },
  {
    ...
    puppyName: 'Luna',
    text: "Our pup Luna is such a sweetheart it nearly melts our hearts every morning. She's healthy, energetic, and gets along incredibly well with our older dog and our visiting nieces. We could not be happier with the entire experience that Elite BoerBoel offered us. They were responsive, transparent, ethical, and clearly invested in their puppies long after they leave the home. The lifetime support has already come in handy more than once. They're a five-star breeder, full stop."
  },
  {
    name: 'Jefferson',
  ...
  },
  {
    ...
    puppyName: 'Bruno',
    text: "Bruno is the perfect addition to our home — smart, deeply affectionate, and clearly raised with so much love and individual attention from his very first weeks. The kids are obsessed with him and he's been remarkably gentle with them in return, even during play. The entire process with Elite BoerBoel was easy, transparent, and full of warmth. We highly recommend them to anyone considering a boerboel puppy and can't imagine going through this experience with any other breeder."
  }
];
